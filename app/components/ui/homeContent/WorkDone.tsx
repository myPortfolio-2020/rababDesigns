...
const WorkDone = () => {
  const shape1 = useRef<HTMLElement | null>(null);
  useEffect(() => {
  ...
  return (
    <>
      ...
      >
        ...
        {/* <div className="shape101 absolute top-2 left:0">
          <div className="shape10 m-3"></div>
          <div className="shape11 m-3"></div>
          <div className="shape12 m-3"></div>
          <div className="shape13 m-3"></div>
        </div> */}
