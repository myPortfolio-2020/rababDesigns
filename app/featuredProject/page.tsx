    ...
    <>
      <div className="max-w-[1288px] mx-auto">
        <div className="flex items-center">
          <ArrowLeft />
          <Link href="/healthcare" className="pl-3">
            Go Back
          </Link>
          <div className="text-[var(--terminalBlue)] text-xl">
            <span className="ml-3 mr-3">|</span>OPD Queue Management System
          </div>
        </div>
          ...
          <div className="xl:w-1/5 w-full">
            <div className="mt-2 pl-3">
              ...
              <div className="text-sm pt-3">
                Patients face high anxiety and &quot;time-loss&quot; in crowded
                clinic waiting rooms due to unpredictable doctor schedules.
              </div>
            ...
            <div className="pl-14">
              <Carousel>
                <CarouselContent>
                  ...
                  <CarouselItem>
                    <div className="pb-2 text-center font-bold">completed</div>
                    <Image
